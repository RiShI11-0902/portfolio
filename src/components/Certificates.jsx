...
const Certification = () => {
    ...
    return (
        <>

            {
                toggle ? <div className="popup-image fixed bg-black z-[100] h-full w-full top-0 left-0 opacity-90">
                    <div className="preview p-5" data-target="number-1">
                        <RxCross1 onClick={() => setToggle(false)} className='bg-white text-black absolute top-5 right-6 cursor-pointer ' />
            ...
            <div className=' text-white  overflow-hidden overflow-y-hidden h-full'>
                {/* <Navbar />
                <Animation /> */}

                <p id='certification' className='text-4xl text-center mt-10 font-extrabold'>CERTIFICATIONS</p>
