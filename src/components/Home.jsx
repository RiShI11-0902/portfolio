  ...
  return (
    <>
      ...
      <div className='bg-gray-900 text-white h-screen overflow-hidden overflow-y-hidden'>
        <Navbar />
        <div className='2xl:mt-10 mainContainer'>
          <div className='mx-auto w-fit  2xl:w-96 flex items-center justify-center p-10'>
        ...
        <div className='flex flex-col 2xl:flex-row items-center 2xl:space-y-0 2xl:space-x-5 w-fit mx-auto space-y-5 '>
          <button className=' shadow-gray-200 hover:border-b-white hover:border-b shadow-sm px-5 py-4 rounded-xl hover:shadow-lg active:scale-95'> <a href="https://drive.google.com/file/d/1DEIu0-9Z7z_PE91C8keF7A12F9qdmvHU/view?usp=drive_link" target='_blank'>Resume</a></button>
          <button className=' shadow-gray-200 hover:border-b-white hover:border-b shadow-sm px-5 py-4 rounded-xl hover:shadow-lg active:scale-95'><Link to={"/navbar"} > Know More </Link></button>
        </div>
